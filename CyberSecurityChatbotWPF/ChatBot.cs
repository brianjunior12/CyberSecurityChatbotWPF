    ...
    public class ChatBot
    {
        ...
        public string ProcessInput(string message)
        {
            ...
            if (message.Contains("interested in"))
            {
                ...
                MemoryManager.FavoriteTopic = topic;

                return
                    $"That's great {userName}! " +
                    $"I will remember that you're interested in {topic}.\n\n" +
                    $"Learning more about {topic} is an excellent way " +
                    $"to improve your cybersecurity awareness.";
            }
